...
const Features = () => {
  ...
  return (
    <section className="py-20 bg-[#030F6D] text-white w-full overflow-hidden">
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8 w-full">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 w-full">
          {features.map((feature, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 w-full">
        ...
        {/* Process Steps */}
        <div className="grid md:grid-cols-4 gap-6 w-full relative">
          {[
